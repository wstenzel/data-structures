...
/**
   Below is the hash set implementation from Section 16.4
   (with one additional method added for testing). 
   Reallocate the buckets of this hash set implementation
   when the load factor is greater than 1.0 or less than 0.5, 
   doubling or halving its size. Note that you need to 
   recompute the hash values of all elements.
   You will have to decide which methods to modify or
...
public class HashSet
{
   ...
   public int getBucketsSize() { return buckets.length; }
