...
/**
   Below is the hash set of Section 16.4 that uses linked chaining.
   Modify the implementation to use open addressing.
   For this problem, use linear probing.
   When removing an element that is followed by other elements
   with the same hash code, replace it with the last such element.
   Please leave the toString method in place. It is used for testing.
*/
